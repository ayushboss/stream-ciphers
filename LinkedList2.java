...
public class LinkedList2<AnyType> implements Iterable<AnyType> {
	 ...
	 */
	public LinkedList2<AnyType> copy1() {
		LinkedList2<AnyType> twin = new LinkedList2<AnyType>();
		Node<AnyType> tmp = head;
		while (tmp != null) {
	 ...
	 */
	public LinkedList2<AnyType> copy2() {
		LinkedList2<AnyType> twin = new LinkedList2<AnyType>();
		Node<AnyType> tmp = head;
		while (tmp != null) {
	 ...
	 */
	public LinkedList2<AnyType> reverse() {
		LinkedList2<AnyType> list = new LinkedList2<AnyType>();
		Node<AnyType> tmp = head;
		while (tmp != null) {
	 ...
	 * Complexity: O(n)
	 */
	public LinkedList2<AnyType> copy3() {
		LinkedList2<AnyType> twin = new LinkedList2<AnyType>();
		Node<AnyType> tmp = head;
		if (head == null)
			return null;
	...
	public static void main(String[] args) {
		...
		LinkedList2<String> twin = list.copy3();
