...
pathZ = "/Volumes/NO NAME/Tamir Research/raw_zip_files/PCG64/PCG64_iteration_"

for idx in range(956, 957):
    ...
    with ZipFile(str(pathZ) + str(idx) + ".zip", 'r') as zip:
        ...
        sp800_22_tests.test_func(data_array_int, "sp800_collected_cluster_data_PCG64_fix.csv", 'threefry', idx, True)
